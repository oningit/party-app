...
(function($){
    ...
    var JoldLoadVideo = function( element, options ) {
        ...
        $element.each(function() {
            ...
            $(iframe).attr('style', 'top:0px; position:absolute; height:700px; width:100%; z-index:0;');
            $(iframe).attr('allow', 'accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture');

            $(iframecover).attr('style', 'top:0; position:absolute; height:700px; width:100%; z-index:1; opacity:1;');
